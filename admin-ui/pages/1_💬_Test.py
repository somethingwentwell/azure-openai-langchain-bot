...
async def main():
    ...
    add_selectbox = st.selectbox(
        "Select Agent Type",
        ("DIRECT_GPT", "AOAI_FUNCTIONS", "CUSTOM_LLM", "CHAT_CONVERSATIONAL_REACT_DESCRIPTION", "CHAT_ZERO_SHOT_REACT_DESCRIPTION", "STRUCTURED_CHAT_ZERO_SHOT_REACT_DESCRIPTION", "CUSTOM_AGENT")
    )
