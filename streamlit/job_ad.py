...
st.set_page_config(page_title="Job Ad Creator", layout="wide", page_icon=":page_facing_up:")
...
def insource(jobtitle, requirements):
    ...
    payload = {  
      "id": "2",  
      "text": f"I'm hiring for the position of {jobtitle} for Swire Properties. Could you write a job description based on the template below by filling in items in [bracket]. /// [company name] Full Time - [Fill in Job title] Job Description [Fill in description of the company] Responsibilities: [Fill in suggested responsibilities] Requirements: {requirements} [Fill in additional suggested requirements] ///"  
    }
